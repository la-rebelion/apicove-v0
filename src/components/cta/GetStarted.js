...
export default ({
  text = "We are in the early access phase and are excited to work with some early customers. We'll be rolling out to more people soon.",
  primaryLinkText = "Add Me to the Waitlist",
  primaryLinkUrl = "http://apicove.com",
  secondaryLinkText = "Contact Us",
  secondaryLinkUrl = "http://apicove.com",
  pushDownFooter = true
}) => {
  return (
