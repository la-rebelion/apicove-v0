...
export default ({
  ...
  description = "The goal of APICove is to provide a platform where developers can find the most important APIs in one place, but not only the documentation, it provides Simulators to test the APIs and also provides a list of tutorials and resources to learn more about the APIs."
}) => {
  /*
      ...
      <Container tw="bg-gray-100 -mx-8 -mt-8 pt-8 px-8">
        <Content2Xl>
          ...
          <HeroRow>
            <UpdateNotice>
              <UpdateNoticeIcon />
              Swagger to Jest and Swagger to Strapi Converters are now available!
            </UpdateNotice>
            <TextColumn>
